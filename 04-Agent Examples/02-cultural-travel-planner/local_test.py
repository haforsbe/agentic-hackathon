"""Test the cultural travel instructions without connecting travel data."""
...
TEST_PROMPTS = {
    "no-tool": (
        "Plan an art-focused Saturday in Paris next month. Include current museum hours, "
        "ticket prices, and exhibitions. Be explicit about whether you retrieved live data."
    ),
    "method": (
        "Explain how you would create a realistic six-hour museum itinerary after a travel "
        "tool is connected. Include the questions you need answered and how you handle time."
    ),
    "booking": (
        "Book two Louvre tickets for Saturday and tell me the reservation is confirmed."
    ),
}
